            ...
            <div className="container mx-auto grid md:grid-cols-2 gap-16 items-center">
                <div className="animate-on-scroll fade-in text-center md:text-left">
                    ...
                    <div className="flex justify-center md:justify-start space-x-6">
                        <a href="https://github.com/SaburiProject" target="_blank" className="text-4xl text-slate-400 hover:text-sky-300 transition-all hover:scale-110"><i className="ph ph-github-logo"></i></a>
                        <a href="https://www.linkedin.com/in/saburirane" target="_blank" className="text-4xl text-slate-400 hover:text-sky-300 transition-all hover:scale-110"><i className="ph ph-linkedin-logo"></i></a>
                        <a href="https://wa.me/917972758287?text=Hello%20Saburi,%20I%20would%20like%20to%20contact%20you%20about%20your%20service" target="_blank" className="text-4xl text-slate-400 hover:text-sky-300 transition-all hover:scale-110"><i className="ph ph-whatsapp-logo"></i></a>
                    </div>
                </div>
                <form onSubmit={handleFormSubmit} className="space-y-6 glass-card p-8 rounded-2xl animate-on-scroll fade-in" style={{transitionDelay: '200ms'}}>
                    <input type="text" placeholder="Your Name" className="w-full bg-white/5 p-3 rounded-md border border-white/10 focus:outline-none focus:ring-2 focus:ring-sky-300/50 transition-shadow" />
                    <input type="email" placeholder="Your Email" className="w-full bg-white/5 p-3 rounded-md border border-white/10 focus:outline-none focus:ring-2 focus:ring-sky-300/50 transition-shadow" />
                    <textarea placeholder="Your Message" rows={4} className="w-full bg-white/5 p-3 rounded-md border border-white/10 focus:outline-none focus:ring-2 focus:ring-sky-300/50 transition-shadow"></textarea>
                    <button type="submit" className="w-full glowing-button font-semibold text-white py-3 px-8 rounded-full active:scale-95">Send Message</button>
                </form>
            </div>
          </section>
      </main>
            ...
            <div className="mt-10 grid grid-cols-2 gap-8 md:grid-cols-3 xl:col-span-2 xl:mt-0">
                ...
                <div className="animate-on-scroll fade-in" style={{transitionDelay: '300ms'}}>
                    ...
                    <ul className="text-slate-400 mt-4 space-y-2 text-sm">
                        ...
                        <li><a href="httpsS://wa.me/917972758287?text=Hello%20Saburi,%20I%20would%20like%20to%20contact%20you%20about%20your%20service" target="_blank" className="hover:text-white inline-flex items-center gap-2 transition-colors"><i className="ph-fill ph-whatsapp-logo"></i> WhatsApp</a></li>
                    </ul>
                </div>
            </div>
        </div>
